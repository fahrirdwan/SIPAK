...
class ChatController extends Controller
{
    public function index()
    {
        ...
        return view('pages.app.admin.chat.index', compact('menu','users','chat_from_me','chat_from_other'));
    }
    ...
    public function create_topic(Request $req, $name, $session_chat)
    {
        ...
        return view('pages.app.admin.chat.create_topic', compact('menu','user','session_chat'));            
    }
    ...
    public function create_chat($session_chat)
    {
        ...
        return view('pages.app.admin.chat.chat_session', compact('menu','user','messages','status_chat'));
    }
