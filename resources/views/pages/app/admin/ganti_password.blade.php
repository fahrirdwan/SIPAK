    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow p-2">
                <div class="card-body">
                    <form action="/admin/ganti-password" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name">Masukkan Password Lama</label> <br>
                            <input id="name" type="password" name="old_password" class="form-control password_input_1" name="old_password" id="old_password">
