    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow p-2">
                <div class="card-body">
                    <form action="/admin/{{ $jenis_bg }}/edit-data/{{ $barang->serial_number  }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input id="serial_number" type="text" name="serial_number" class="form-control" value="{{ $barang->serial_number }}">
