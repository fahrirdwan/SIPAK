        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow mt-3">
                <div class="card-body">
                  ...
                  <p class="mt-3">Topik : {{ $chat->topic_chat }} <a href="/admin/chat/session/{{ $chat->session_chat }}" class="badge bg-primary text-white">lanjutkan chat</a></p>
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow mt-3">
                <div class="card-body">
                  ...
                  <p class="mt-3">Topik : {{ $chat->topic_chat }} <a href="/admin/chat/linked_session/{{ $chat->session_chat }}" class="badge bg-primary text-white">lanjutkan chat</a></p>
                  <p>{{ \Carbon\Carbon::parse($chat->created_at)->format('d F Y H:i') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-8 mb-5">
                    <img src="/img/profil/{{ $user->picture }}" class="img-fluid rounded-circle" width="80"> {{ $user->name }} <a href="/admin/chat/{{ $user->name }}/{{ rand(0, 10000000) }}" class="badge bg-success text-white">mulai chat</a>
                </div>
                <hr/>
                @endif
                @endforeach
