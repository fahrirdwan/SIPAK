...
<body>
  <div class="page">
      ...
      <table width="700">
        <center>
            <b><font size="4">BERITA ACARA PENGEMBALIAN ASET KANTOR</font></b>
        </center><br><br>
      </table>
      <table>
        <tr>
      ...
      <table width="778">
        <tr>
          ...
          <tr>
            <td>Sepesifikasi Aset</td>
            <td>:</td>
            <td>{{ strip_tags($pengembalian->detail) }}</td>
          </tr>
          <!-- <tr>
    ...
    <br>
      <p style="margin-top: 10px; line-height: 1.5;">Telah melakukan pengembalian aset alat kantor berupa <b>{{ $pengembalian->jenis_barang }}</b>. Pada hari <b>{{ \Carbon\Carbon::parse($pengembalian->created_at)->locale('id')->isoFormat('dddd, D MMMM Y') }}</b>. Dalam Kondisi <b>{{ $pengembalian->kondisi_barang }}</b></p>
      <p style="margin-top: 10px; line-height: 1.5; text-align:justify;">Demikian berita acara serah terima aset ini dibuat untuk dapat dipergunakan dengan sebagaimana mestinya</p>
 {{-- <p style="margin-top: 20px; line-height: 1.;">Demikian berita acara ini dibuat 2 (dua) rangkap untuk dapat dipergunakan dengan sebagaimana mestinya.</p> --}}
      ...
      <div style="margin-top: 50px; float: left;">
        <div style="width: 250px">
          <p><b> Jakarta, {{ \Carbon\Carbon::parse($pengembalian->created_at)->locale('id')->isoFormat('dddd, D MMMM Y') }}</b></p>
          <p>Mengetahui</p><br><br><br><br>
          <span style="margin-top: 90px;">{{ Auth::user()->name }}<br> NIP. {{ Auth::user()->nip }}</span>
        </div>
      </div>
      <div style="margin-top: 105px; float: right;">
        <div style="width: 250px">
          <p>Pengguna</p><br><br><br><br>
          <span>{{ $pengembalian->name }}<br> NIP. {{ $pengembalian->nip }}</span>
